...
static void
lck_mtx_ext_init(lck_mtx_ext_t *lck,
                 lck_grp_t *grp,
                 lck_attr_t *attr)
{
...
void
lck_mtx_init_ext(lck_mtx_t *lck,
                 lck_mtx_ext_t *lck_ext,
                 lck_grp_t *grp,
                 lck_attr_t *attr)
{
...
void
lck_spin_destroy(lck_spin_t *lck,
                 lck_grp_t *grp)
{
...
void
usimple_lock_init(usimple_lock_t l,
                  unsigned short tag)
{
...
void
lck_mtx_lock_mark_destroyed(lck_mtx_t *mutex)
{
    return;
}
