...
#ifndef _KDP_ARM_COMMON_H_
#define _KDP_ARM_COMMON_H_
 ...
 */
typedef int (*pmap_traverse_callback)(vm_map_offset_t start, vm_map_offset_t end, void *context);

extern int pmap_traverse_present_mappings(pmap_t pmap, vm_map_offset_t start, vm_map_offset_t end, pmap_traverse_callback callback, void *context);

extern size_t kern_collectth_state_size(void);
extern void kern_collectth_state(thread_t thread, void *buffer, size_t size);

#endif /* _KDP_ARM_COMMON_H_ */
